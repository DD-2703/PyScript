...
setup(
  ...
  author_email = 'darshdane@duck.com',
  url = 'https://github.com/DD-2703/PyScript',
  download_url = 'https://github.com/DD-2703/PyScript/archive/refs/tags/v0.1.tar.gz',    # I explain this later on
